...
using Arohan.TollSphere.Application.Features.SystemLogs.Caching;
using Arohan.TollSphere.Application.Features.SystemLogs.DTOs;
using Arohan.TollSphere.Application.Features.SystemLogs.Specifications;

namespace Arohan.TollSphere.Application.Features.SystemLogs.Queries.PaginationQuery;
