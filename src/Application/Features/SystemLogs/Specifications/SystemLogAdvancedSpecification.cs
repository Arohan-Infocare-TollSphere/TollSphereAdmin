using Arohan.TollSphere.Application.Features.SystemLogs.Queries.PaginationQuery;

namespace Arohan.TollSphere.Application.Features.SystemLogs.Specifications;
