using Arohan.TollSphere.Application.Features.AuditTrails.Queries.PaginationQuery;

namespace Arohan.TollSphere.Application.Features.AuditTrails.Specifications;
