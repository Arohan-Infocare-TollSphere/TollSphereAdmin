...
using Arohan.TollSphere.Application.Features.AuditTrails.Caching;
using Arohan.TollSphere.Application.Features.AuditTrails.DTOs;
using Arohan.TollSphere.Application.Features.AuditTrails.Specifications;

namespace Arohan.TollSphere.Application.Features.AuditTrails.Queries.PaginationQuery;
