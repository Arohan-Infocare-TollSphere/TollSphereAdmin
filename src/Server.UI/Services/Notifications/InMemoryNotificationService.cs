...
namespace Arohan.TollSphere.Server.UI.Services.Notifications;
...
public class InMemoryNotificationService : INotificationService
{
    ...
    public void Preload()
    {
        _messages.Add(new NotificationMessage(
            ...
            "https://github.com/Arohan-Infocare-TollSphere/TollSphereAdmin/actions/workflows/dotnet.yml/badge.svg",
            new[]
            {
