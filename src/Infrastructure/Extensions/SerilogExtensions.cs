...
namespace Arohan.TollSphere.Infrastructure.Extensions;
    ...
    public static void RegisterSerilog(this WebApplicationBuilder builder)
    {
        ...
        builder.Host.UseSerilog((context, configuration) =>
            configuration.ReadFrom.Configuration(context.Configuration)
                ...
                .MinimumLevel.Override("Arohan.TollSphere.Server.UI.Services.Fusion.UserSessionTracker", LogEventLevel.Error)
                .MinimumLevel.Override("Arohan.TollSphere.Server.UI.Services.Fusion.OnlineUserTracker", LogEventLevel.Error)
    ...
    // Removed legacy in-memory database skip; logging to database now always attempts based on configured provider.
        ...
        switch (dbProvider)
        {
            ...
            case DbProviderKeys.SqLite:
                WriteToSqLite(serilogConfig, "\\TollSphereDashboardDb.db");
                break;
        }
    }
