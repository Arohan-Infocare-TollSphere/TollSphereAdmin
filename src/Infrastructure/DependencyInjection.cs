...
using Arohan.TollSphere.Application.Common.Constants;
using Arohan.TollSphere.Application.Common.Security;
using Arohan.TollSphere.Domain.Identity;
using Arohan.TollSphere.Infrastructure.Configurations;
using Arohan.TollSphere.Infrastructure.Persistence.Interceptors;
using Arohan.TollSphere.Infrastructure.Services.Circuits;
using Arohan.TollSphere.Infrastructure.Services.Gemini;
using Arohan.TollSphere.Infrastructure.Services.MultiTenant;
...
namespace Arohan.TollSphere.Infrastructure;
...
public static class DependencyInjection
{
    ...
    private const string POSTGRESQL_MIGRATIONS_ASSEMBLY = "Arohan.TollSphere.Migrators.PostgreSQL";
    private const string MSSQL_MIGRATIONS_ASSEMBLY = "Arohan.TollSphere.Migrators.MSSQL";
    private const string SQLITE_MIGRATIONS_ASSEMBLY = "Arohan.TollSphere.Migrators.SqLite";
    ...
    private const string DEFAULT_FROM_EMAIL = "noreply@arohaninfocare.in";
